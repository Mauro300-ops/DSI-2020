...
namespace AgregarCarrito_openShop
{
    class GestorVentas
    {
        ...
        {
            FormasPagos.Add(new FormasPago("6 cuotas sin interés"));
        ...
        static public void AgregarPago()
        {
            ...
            System.Console.WriteLine();
            System.Console.WriteLine("Seleccione una forma de pago (ingrese 1 o 2)");
    ...
    class RegistroProductos
    {
        ...
        static RegistroProductos()
        {
            ...
            Productos.Add(new Producto("Celular", 250000, "Apple"));
            Productos.Add(new Producto("Televisor", 22000, "Samsung"));
            Productos.Add(new Producto("Ojotas", 700, "Havaianas"));
            Productos.Add(new Producto("Teclado", 6500, "Red dragon"));
        }
